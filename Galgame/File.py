...
def parse_args(args=None, namespace=None):
    ...
    p.add_argument('--audio_dir',  default=r"D:\voice")
    p.add_argument('--index_json', default=r"D:\index.json")
    p.add_argument('--out_dir',    default=r"D:\Dataset_VN_NoScene\Onomatope Raspberry_Saimin Paradise! ~Saiminjutsu de Tsugou no Ii Bishoujo Gakuen Seikatsu~")
