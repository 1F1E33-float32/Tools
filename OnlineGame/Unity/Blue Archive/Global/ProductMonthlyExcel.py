...
def ProductMonthlyExcelAddParcelType(builder, parcelType):
    builder.PrependUOffsetTRelativeSlot(10, flatbuffers.number_types.UOffsetTFlags.py_type(parcelType), 0)
...
def ProductMonthlyExcelAddParcelAmount(builder, parcelAmount):
    builder.PrependUOffsetTRelativeSlot(12, flatbuffers.number_types.UOffsetTFlags.py_type(parcelAmount), 0)
...
def ProductMonthlyExcelAddDailyParcelType(builder, dailyParcelType):
    builder.PrependUOffsetTRelativeSlot(14, flatbuffers.number_types.UOffsetTFlags.py_type(dailyParcelType), 0)
...
def ProductMonthlyExcelAddDailyParcelId(builder, dailyParcelId):
    builder.PrependUOffsetTRelativeSlot(15, flatbuffers.number_types.UOffsetTFlags.py_type(dailyParcelId), 0)
...
def ProductMonthlyExcelAddDailyParcelAmount(builder, dailyParcelAmount):
    builder.PrependUOffsetTRelativeSlot(16, flatbuffers.number_types.UOffsetTFlags.py_type(dailyParcelAmount), 0)
