...
if __name__ == "__main__":
    ...
    parser.add_argument("--input_root", default=r"D:\Dataset_Game\com.bluepoch.m.en.reverse1999\EXP\audios\Android", help="Source directory of .wem files")
    parser.add_argument("--output_root", default=r"D:\Dataset_Game\com.bluepoch.m.en.reverse1999\EXP\audios\Android_WAV", help="Destination directory for .wav files")
    parser.add_argument("--vgmstream_exe", default=r"D:\Tools\vgmstream-win64\vgmstream-cli.exe", help="Path to vgmstream-cli executable")
    parser.add_argument("--workers", type=int, default=40, help="Number of parallel threads (default: number of CPU cores)")
    args = parser.parse_args()

    convert_wems(input_root=args.input_root, output_root=args.output_root, vgmstream_exe=args.vgmstream_exe, workers=args.workers)
