...
def query_vndb(name):
    payload = {"filters": ["search", "=", name], "fields": "id,title,alttitle", "sort": "title", "reverse": True, "page": 1, "results": 50}
...
def generate_metadata_for_folder(folder_path):
    ...
    metadata = {"game_name": game_name, "game_name_romaji": game_name_romaji, "game_developer": developer_name, "game_category": "galgame", "game_link": f"https://vndb.org/{vn_id}"}
