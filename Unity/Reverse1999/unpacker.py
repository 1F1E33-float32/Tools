...
if __name__ == "__main__":
    ...
    parser.add_argument("--src", default=r"D:\Dataset_Game\com.bluepoch.m.en.reverse1999\RAW\bundles_dec")
    parser.add_argument("--dst", default=r"D:\Dataset_Game\com.bluepoch.m.en.reverse1999\EXP\Story")
    parser.add_argument("--id", default=True)
    parser.add_argument("--ignore", type=int, default=1, metavar="N")
