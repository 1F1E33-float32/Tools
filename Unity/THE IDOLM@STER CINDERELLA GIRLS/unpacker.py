...
if __name__ == "__main__":
    ...
    parser.add_argument("--src", default=r"D:\Dataset_Game\jp.co.bandainamcoent.BNEI0242\RAW\a")
    parser.add_argument("--dst", default=r"D:\Dataset_Game\jp.co.bandainamcoent.BNEI0242\EXP\Story")
