...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_dir', default=r"D:\GAL\2009年1月\2009年1月\Suzunone Seven!")
    parser.add_argument('--output_dir', default=r"D:\Fuck_galgame")
