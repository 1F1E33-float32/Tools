...
class VMParser:
    ...
    def _read_vars(self):
        ...
        for _ in range(count):
            ...
            name = name_bytes.decode("cp932").rstrip("\x00")
            ...
            # Read additional 3 uint32 values
            for _ in range(3):
    ...
    def _read_functions(self):
        print("functions start", self.reader.tell())
        ...
        for i in range(count):
            ...
            func = FunctionItem(name, i, None, vm_code_offset)
            self.functions.append(func)
            self.functions_by_name[name] = func
            self.functions_by_id[i] = func

    def _read_labels(self):
        print("labels start", self.reader.tell())
        count = self._read_uint32()
    ...
    def _read_strings(self):
        ...
        _ = self._read_uint32() # table_length
