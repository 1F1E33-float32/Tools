...
fnv_unk = "???"
fnv_order = [fnv_bnk, fnv_lng, fnv_evt, fnv_bus, fnv_sfx, fnv_trg, fnv_aco, fnv_gme, fnv_gmx, fnv_var, fnv_val, fnv_unk]
fnv_order_join = [fnv_bnk, fnv_lng, fnv_bus]
fnv_conditionals = {fnv_gmx}
fnv_conditionals_origin = {fnv_gme}
...
AkPropID = None
AkPropID_tids = {"AttachedPluginFXID", "AttenuationID"}
